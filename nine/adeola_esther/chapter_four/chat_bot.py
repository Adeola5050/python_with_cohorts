    ...
    while response == "yes":
        ...
        dictionary = {
           "time": ["The time is " + str(datetime.datetime.now().time()), "Go buy wristwatch"],
            ...
            "age": ["I am " + str(random.randint(1, 100)) + "year old"],
            ...
            "sleep": ["I rarely sleep mehn", "I can't shutdown, I can only have a 10sec power nap daily"],
             "hobby":["I love to dance a lot", "Dancing is my hobby"],
             "nickname":["Thick body", "Hefty", "Wonderfully made", "Big Bold and Beautiful"],
             "address":["Ya mama", "You wanna visit?", "Common Getout!"]
        }
